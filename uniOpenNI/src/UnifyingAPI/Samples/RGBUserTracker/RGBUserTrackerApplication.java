...
public class RGBUserTrackerApplication {

   /**
	 * 
	 */
	public RGBUserTracker viewer;
	private boolean shouldRun = true;
	private JFrame frame;

   public RGBUserTrackerApplication (JFrame frame)
   {
   	this.frame = frame;
   ...
   public static void main(String s[])
   {
       ...
       RGBUserTrackerApplication app = new RGBUserTrackerApplication(f);
       
       app.viewer = new RGBUserTracker();
